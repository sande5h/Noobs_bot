    ...
    <div className={styles.page}>
      <div className={styles.container}>
        ...
        <section className={styles.calc}>
              ...
              <div key={key} className={styles.field}>
                ...
                {hillActive ? (
                  <input
                    ...
                    step={step}
                    placeholder="0"
                    onChange={e => setHill(h => ({ ...h, [key]: e.target.value }))}
                  />
                ) : (
                  <input
                    type="text"
                    className={`${styles.input} ${styles.inputReadonly}`}
                    value={fmt(outHill[key], key === 'dam' ? 3 : 0)}
                    readOnly
                  />
                )}
              </div>
          ...
          <div className={styles.divider}>
            ...
            <span className={styles.dividerLabel}>
              {hillActive ? 'Hill → Terai' : 'Terai → Hill'}
            </span>
          </div>
              ...
              <div key={key} className={styles.field}>
                ...
                {teraiActive ? (
                  <input
                    ...
                    step={step}
                    placeholder="0"
                    onChange={e => setTerai(t => ({ ...t, [key]: e.target.value }))}
                  />
                ) : (
                  <input
                    type="text"
                    className={`${styles.input} ${styles.inputReadonly}`}
                    value={fmt(outTerai[key], key === 'dhur' ? 3 : 0)}
                    readOnly
                  />
                )}
              </div>
        ...
        <footer className={styles.footer}>
          Calculations follow Government of Nepal Survey Department standard values.
        </footer>
